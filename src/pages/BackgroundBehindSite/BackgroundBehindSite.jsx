  ...
  return (
    <PageContainer>
      ...
      <section className="statement">
        ...
        <h2 className="accent-text dramatic-line">
          Remembering It Was.
        </h2>
      ...
      <section className="build-process">
        ...
        <div className="build-track">
          ...
          <div className="build-card">
            <h3>Research</h3>
            <p>
              Watch videos and collect concepts.
            </p>
          </div>
          ...
          <div className="build-card">
            <h3>Write Notes</h3>
            <p>
              Short revision friendly explanations.
            </p>
          </div>
          ...
          <div className="build-card">
            ...
            <p>
              Concepts developers actually need.
            </p>
          </div>
      ...
      <section className="statement">
        ...
        <p className="topics-hero__footer-text">
          ...
          Many concepts inside ChaiScript were
          learned while following Chai Aur Code.
        </p>
